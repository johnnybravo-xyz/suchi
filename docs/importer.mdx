...
| 8-16 date filters (created/added/modified before/after)              | —                         | Failed — importer does not translate source-system date rules; Suchi rich queries support `added:` and accepted `date:` intelligence |
