...
- Children inherit the original capture time, filing category, and sensitivity
  immediately. Device OCR belongs to the combined feeder scan and is not copied
  to a segment; each child runs server extraction independently.
