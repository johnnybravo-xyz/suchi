...
`ocrmypdf`. Install via the appropriate package (see the [Docker
matrix](#docker-image-matrix) or build from source at
[github.com/firecrawl/anydoc](https://github.com/firecrawl/anydoc)),
then re-ingest.
