...
mail-intake emits Paperless-native flat JSON:
...
`core/ingest/sidecar` transparently accepts the Paperless-native
...
Paperless-native shape (portable) OR the versioned suchi-native form
