...
code on close. Late responses cannot populate another account's prompt.
...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,566 | 34,707 |
| Documents / Inbox | 27,373 | 10,056 |
| Document detail | 35,118 | 12,242 |
| Upload | 13,112 | 5,962 |
| Search | 8,894 | 4,285 |
| Views | 14,629 | 5,289 |
| Calendar | 16,334 | 6,375 |
| Trash | 8,327 | 3,921 |
| Approvals | 18,351 | 6,551 |
| Automations | 17,940 | 5,919 |
| My account, without mailbox capability | 13,156 | 4,817 |
| Archive configuration, including its Settings entry | 107,746 | 35,701 |
| Setup | 66,511 | 22,202 |
| Demo | 5,578 | 2,338 |
| Archive research drawer | 13,763 | 5,282 |
| **All unique JavaScript chunks** | **388,668** | **138,128** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
22,018 gzip bytes. The complete embedded SPA tree is 481,087 raw bytes. Shared
