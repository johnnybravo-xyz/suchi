...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,740 | 34,747 |
| Documents / Inbox | 25,011 | 9,191 |
| Document detail | 28,767 | 9,756 |
| Upload | 6,432 | 2,990 |
| Search | 5,807 | 2,804 |
| Views | 14,630 | 5,356 |
| Calendar | 13,357 | 5,121 |
| Trash | 6,025 | 2,808 |
| Approvals | 18,903 | 6,782 |
| Automations | 17,941 | 5,969 |
| My account, without mailbox capability | 12,965 | 4,773 |
| Archive configuration, including its Settings entry | 107,544 | 35,756 |
| Setup | 66,502 | 22,271 |
| Demo | 5,583 | 2,343 |
| Archive research drawer | 13,759 | 5,324 |
| **All unique JavaScript chunks** | **355,982** | **126,798** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
21,407 gzip bytes. The complete embedded SPA tree is 444,831 raw bytes. Shared
