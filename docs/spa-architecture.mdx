...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,507 | 34,649 |
| Documents / Inbox | 25,011 | 9,190 |
| Document detail | 25,944 | 9,001 |
| Upload | 6,432 | 2,991 |
| Search | 5,807 | 2,805 |
| Views | 14,428 | 5,281 |
| Calendar | 9,222 | 3,805 |
| Trash | 5,536 | 2,640 |
| Approvals | 18,701 | 6,708 |
| Automations | 17,941 | 5,968 |
| My account, without mailbox capability | 12,965 | 4,773 |
| Archive configuration, including its Settings entry | 107,544 | 35,755 |
| Setup | 66,502 | 22,268 |
| Demo | 5,583 | 2,344 |
| Archive research drawer | 13,753 | 5,335 |
| **All unique JavaScript chunks** | **348,296** | **124,470** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
20,357 gzip bytes. The complete embedded SPA tree is 434,938 raw bytes. Shared
...
unrelated screens. Compared with the former grouped entries at the same pins,
Documents needs 48% less route JavaScript, Upload 83% less, and ordinary My
account 85% less. The sum of all compressed JavaScript is 8.4% larger, and the
shell grows by 174 bytes. These are transfer-size measurements, not browser
memory or startup-latency claims.
