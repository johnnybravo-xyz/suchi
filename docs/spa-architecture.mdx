...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,977 | 34,805 |
| Documents / Inbox | 29,450 | 10,876 |
| Document detail | 38,632 | 13,362 |
| Upload | 13,631 | 6,234 |
| Search | 9,413 | 4,575 |
| Views | 16,510 | 5,909 |
| Calendar | 16,913 | 6,645 |
| Trash | 8,846 | 4,175 |
| Approvals | 18,351 | 6,614 |
| Automations | 17,940 | 5,989 |
| My account, without mailbox capability | 15,908 | 5,868 |
| Mobile pairing prompt, when opened from My account | 8,522 | 4,190 |
| Archive configuration, including its Settings entry | 110,390 | 36,848 |
| Setup | 66,406 | 22,246 |
| Demo | 5,812 | 2,401 |
| Archive research drawer | 13,763 | 5,298 |
| **All unique JavaScript chunks** | **403,884** | **144,326** |

The initial shell also transfers 5,219 gzip bytes of CSS. All CSS together is
22,722 gzip bytes. The complete embedded SPA tree is 498,219 raw bytes. Shared
chunks are cached across navigation; do not sum the route rows to estimate the
complete build. A mailbox-capable member additionally loads 10,514 gzip bytes
