...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,846 | 34,867 |
...
| **All unique JavaScript chunks** | **356,764** | **126,956** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
21,392 gzip bytes. The complete embedded SPA tree is 445,450 raw bytes. Shared
