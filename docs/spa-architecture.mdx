...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,753 | 34,780 |
| Documents / Inbox | 27,360 | 10,034 |
| Document detail | 35,114 | 12,311 |
| Upload | 13,111 | 5,953 |
| Search | 8,894 | 4,305 |
| Views | 14,630 | 5,275 |
| Calendar | 16,336 | 6,380 |
| Trash | 8,327 | 3,915 |
| Approvals | 18,351 | 6,571 |
| Automations | 17,942 | 5,903 |
| My account, without mailbox capability | 14,055 | 5,033 |
| Mobile pairing prompt, when opened from My account | 8,008 | 3,943 |
| Archive configuration, including its Settings entry | 108,632 | 35,914 |
| Setup | 66,510 | 22,211 |
| Demo | 5,583 | 2,341 |
| Archive research drawer | 13,763 | 5,297 |
| **All unique JavaScript chunks** | **394,133** | **140,535** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
22,434 gzip bytes. The complete embedded SPA tree is 487,500 raw bytes. Shared
chunks are cached across navigation; do not sum the route rows to estimate the
complete build. A mailbox-capable member additionally loads 10,493 gzip bytes
