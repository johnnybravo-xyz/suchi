...
| --- | --- | ---: |
| Shell | Navigation, Dashboard, and login | 34,093 |
| Document work | Documents, document detail, and Upload | 16,516 |
| Search | Search | 2,426 |
| Organize | Views, Calendar, and Trash | 7,590 |
| Workflow | Approvals and Automations | 11,249 |
| Configuration | Settings and Setup | 31,432 |
| Demo | Demo workspace | 2,363 |
| Archive research | On-demand research drawer | 5,253 |
| Query helpers | Shared by Documents and Search | 415 |
| Date helpers | Shared by Calendar and Approvals | 378 |
| Styles | Shared stylesheet | 14,207 |
...
JavaScript chunks together are 111,715 bytes gzip, but ordinary navigation
