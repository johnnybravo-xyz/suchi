...
| --- | ---: | ---: |
| Shell: navigation, Dashboard, login | 95,565 | 34,672 |
| Documents / Inbox | 25,011 | 9,191 |
| Document detail | 25,944 | 9,000 |
| Upload | 6,432 | 2,992 |
| Search | 5,807 | 2,807 |
| Views | 14,428 | 5,282 |
...
| My account, without mailbox capability | 12,677 | 4,671 |
| Archive configuration, including its Settings entry | 107,256 | 35,650 |
| Setup | 66,502 | 22,267 |
| Demo | 5,583 | 2,343 |
| Archive research drawer | 13,616 | 5,276 |
| **All unique JavaScript chunks** | **347,929** | **124,334** |

The initial shell also transfers 5,092 gzip bytes of CSS. All CSS together is
20,338 gzip bytes. The complete embedded SPA tree is 434,470 raw bytes. Shared
chunks are cached across navigation; do not sum the route rows to estimate the
complete build. A mailbox-capable member additionally loads 10,540 gzip bytes
...
account 86% less. The sum of all compressed JavaScript is 8.3% larger, and the
shell grows by 197 bytes. These are transfer-size measurements, not browser
