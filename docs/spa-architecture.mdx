...
the on-demand archive-question drawer separate. Keep the shell at or below 35 KB gzip and
remeasure every chunk after UI changes. At v0.1.0-beta.1 the gzip sizes are
32.31 KB for the shell, 20.77 KB for archive workflows, 40.11 KB for management
workflows, and 9.86 KB for CSS. This is a transfer-size budget, not a
browser-memory or container-size claim.
