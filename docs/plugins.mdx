...
(`github.com/johnnybravo-xyz/suchi/plugin-api`) with a handful of value types
...
require github.com/johnnybravo-xyz/suchi/plugin-api v0.0.0
require github.com/johnnybravo-xyz/suchi/core v0.0.0
```
