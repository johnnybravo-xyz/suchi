...
8. Adds approved extracted facts attached to those sources when permitted.
...
- Archive evidence includes at most three approved facts per source and twelve
