...
1. Open **Admin > Mail intake**, add a mailbox, and choose **Microsoft**.
...
Open **Admin > Mail intake > Advanced Microsoft settings**, enter the client
ID, and save. New sign-ins and explicit reauthentication use it immediately.
Clear the field to restore the environment fallback or Suchi registration.
