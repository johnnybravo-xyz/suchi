...
every other enabled option. Every section is usable before a tree is chosen.
...
Configuration sections. `#/setup` is not a screen and has no compatibility redirect.
