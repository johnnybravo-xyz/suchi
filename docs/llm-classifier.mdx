...
a field-by-field basis, following the canonical [configuration
...
or archive question answering. The roadmap keeps typed, validated extraction
inside the existing automation engine for v0.2, followed by citation-bound,
ACL-scoped Ask in v0.3. Neither is part of the v0.1 classifier contract.
