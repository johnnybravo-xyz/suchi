...
[`deploy/systemd`](https://github.com/suchi-dms/suchi/tree/main/deploy)
...
ghostscript) pull the **full** image: `ghcr.io/suchi-dms/suchi:latest-full`
...
- Import an existing Paperless-ngx archive: [importer](/importer)
