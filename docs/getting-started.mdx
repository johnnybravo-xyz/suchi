...
setup step. For 48 hours after the first administrator is created, the
Dashboard reminds that administrator to finish setup until they open or close
the reminder, choose a tree, or finish the wizard. Every setup control remains
