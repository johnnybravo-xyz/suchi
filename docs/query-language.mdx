...
The Omnibox and Documents query field recognize an incomplete final qualifier.
...
Snapshot Views instead store bounded `document_ids`. They preserve one exact
source set while still reapplying ACLs whenever opened or shared.
