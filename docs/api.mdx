...
Full-text search over `documents_fts` (title + content). Scope:
`documents:read`. Non-admin callers are ACL-scoped identically to
the list surface — the FTS snippet cannot leak content the caller
can't see.
...
| Param                                                | Purpose                                                                                                                          |
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `q`                                                  | The user's raw query string. Empty → empty envelope.                                                                             |
