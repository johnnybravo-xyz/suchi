---
title: "HTTP API"
description: "JSON endpoints under /api/ — current + planned Paperless-mobile compat."
---

Phase 0/1 surface — grows through Phase 2 (ingest endpoints) and
Phase 4 (Paperless-mobile compat surface).
...
## Paperless-mobile compat (Phase 4)

The endpoints below are planned for Phase 4. They match Paperless-ngx
byte-for-byte on request/response shape so `swift-paperless` and
`Paperless Mobile` work against suchi unchanged.
