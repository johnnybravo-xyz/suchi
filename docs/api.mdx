...
revocations run in the same transaction. Rejected patches and failed cascades
leave the user and resources unchanged; cascade failures return **500**.
Later promotions or regrants cannot be overtaken by older revocations. Resource
logs, audit emission and runtime reloads happen after commit.
