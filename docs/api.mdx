...
Bundle-compatible mobile clients that ignore unknown JSON fields see
...
existing document-management mobile apps (`swift-bundle` on iOS,
`Bundle Mobile` on Android) so no bespoke app is needed.
