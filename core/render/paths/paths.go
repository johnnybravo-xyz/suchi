...
//
// The template surface is intentionally the same shape as paperless-
...
//	{{ owner }}            user email
//
// Missing values render as empty strings, matching Paperless's
...
// Empty input → empty output (silent-empty matches paperless).
