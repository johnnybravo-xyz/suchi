...
// RBAC package will plug into: default rejects role:*, custom resolver
...
// returns a fixed list. Emulates what an enterprise RBAC resolver
// would do: expand "role:X" to concrete user ids.
