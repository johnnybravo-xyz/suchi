...
Paperless-ngx. Phase-4 compat contract tests replay these against
suchi.

Empty until a real Paperless-ngx is available to record from. See
...
- Never commit fixtures containing real personal documents — record
  against a scratch Paperless-ngx seeded with synthetic content
